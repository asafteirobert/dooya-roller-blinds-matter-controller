...
// Bridges BlindController and the physical remote to SX1278Driver's raw radio frames.
//   - Outgoing: gets UP/DOWN/STOP commands from BlindController and sends the corresponding
//     Dooya radio commands to SX1278Driver.
//   - Incoming: decodes frames SX1278Driver receives from the physical remote and routes them to
...
public:
    ...
    void init(SX1278Driver& sx1278Driver);
